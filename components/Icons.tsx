...
export const MapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14.106 5.553a2 2 0 0 0-1.212-.493H6.5a2 2 0 0 0-2 2v11.105a2 2 0 0 0 .548 1.408l4.409 3.651a2 2 0 0 0 2.919-1.21l.362-1.086a2 2 0 0 0-1.21-2.918l-1.634-.545a2 2 0 0 1-1.21-2.918l.362-1.086a2 2 0 0 1 2.918-1.21l1.634.545a2 2 0 0 0 2.918-1.21l.362-1.086a2 2 0 0 0-1.21-2.918Z" />
    <path d="M19.5 5.5a2 2 0 0 0-2-2h-2.148" />
    <path d="M18 13.105V7.5" />
    <path d="M15 22v-4.895" />
  </svg>
);
